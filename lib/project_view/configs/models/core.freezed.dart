...
bool operator ==(Object other) {
  final _this = this as CoreConfigModel;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CoreConfigModel&&(identical(other.acceptDownload, _this.acceptDownload) || other.acceptDownload == _this.acceptDownload)&&(identical(other.renderThreadCount, _this.renderThreadCount) || other.renderThreadCount == _this.renderThreadCount));
}
...
int get hashCode {
  final _this = this as CoreConfigModel;
  return Object.hash(runtimeType,_this.acceptDownload,_this.renderThreadCount);
}

@override
String toString() {
  final _this = this as CoreConfigModel;
  return 'CoreConfigModel(acceptDownload: ${_this.acceptDownload}, renderThreadCount: ${_this.renderThreadCount})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,acceptDownload,renderThreadCount);
}
